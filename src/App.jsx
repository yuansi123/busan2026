...
const foodShortlist = [
  ...
  },
  {
    ...
    picks: [
      { name: '密陽血腸豬肉湯飯 海雲台店', url: maps('밀양순대돼지국밥 해운대') },
  ...
  {
    category: '這次不特地去',
    note: '陜川一流豬肉湯飯在沙上/機場那側，從海雲台飯店過去約 1 小時以上；除非改排沙上或機場附近，不然不適合放抵達日晚餐。',
    picks: [
      { name: '陜川一流豬肉湯飯', url: maps('합천일류돼지국밥 부산 사상') },
    ],
  },
];
...
const tripDays = [
  {
    ...
    plan: [
      ...
      {
        time: '19:00',
        place: '海雲台晚餐：密陽血腸豬肉湯飯 / 草梁小麥麵',
        url: maps('밀양순대돼지국밥 해운대 해운대 초량밀면'),
        detail: '修正：陜川一流在沙上，離海雲台太遠，不排。抵達日改吃飯店附近，想熱湯選密陽血腸豬肉湯飯；想清爽選海雲台草梁小麥麵。',
        transport: '飯店 -> 海雲台周邊晚餐：步行/計程車約 5-15 分。',
        next: '到下一站：去海雲台海灘步行約 5-10 分。',
        reserve: '不用預約，先用 Naver Map 確認當天營業。',
        icon: Utensils,
      },
      {
        time: '20:30',
    ...
    meals: ['密陽血腸豬肉湯飯 海雲台店', '海雲台草梁小麥麵', '海雲台名品糖餅', '常客客人宵夜備案'],
